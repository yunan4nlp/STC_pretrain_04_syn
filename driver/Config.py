...
class Configurable(object):
    ...
    @property
    def src_emb(self):
        return self._config.get('Data', 'src_emb')

    @property
    def tgt_emb(self):
        return self._config.get('Data', 'tgt_emb')
    ...
    @property
    def parser_tune(self):
        return self._config.getfloat('Network', 'parser_tune')
    ...
    @property
    def min_src_length(self):
        return self._config.getint('Run', 'min_src_length')

    @property
    def min_tgt_length(self):
        return self._config.getint('Run', 'min_tgt_length')
